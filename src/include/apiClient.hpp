...
std::string fetchSeriesRaw(const std::string &url, const std::string &searchString,
...
std::string fetchEpisodesRaw(const std::string &url, const std::string &seriesId,
                             const std::string &apiKey);
} // namespace jellyfin
...
std::string base64ToTitle(const std::string &base64, const std::string &googleApiKey);
}
